...
public class MemberController {
	...
	public String handleSQLIntegrityConstraintViolationException(java.sql.SQLIntegrityConstraintViolationException e,
			HttpServletRequest req) {
		/*
		 * 오류 보고 - SQL 오류: ORA-02290: check constraint (MYORAUSER.CK_TX_MEMBER_POINT)
		 * violated
		 */
	...
	public ModelAndView loginEnd(ModelAndView mv, HttpServletRequest request)
...
//				mv.setViewName("jiyoung/login.tiles1");
	...
	/*
	 * @RequestMapping(value="/memberEdit.go") public ModelAndView
	 * memberEdit(ModelAndView mv,HttpServletRequest request,MemberVO vo) {
	 * HttpSession session = request.getSession(); vo =
	 ...
	 * 
	 * mv.addObject("vo",vo); mv.setViewName("jiyoung/memberEdit.tiles1"); return
	 * mv; }
	 */
...
//			System.out.println("getIdx() : " + idx);
	...
	public String photoaddeditEnd(MemberVO membervo, MultipartHttpServletRequest mrequest, HttpServletRequest request) {
		...
		if (!attach.isEmpty()) {
			...
			String path = "C:\\Users\\user1\\git\\finalProjectB\\FinalProjectB\\src\\main\\webapp\\resources"
					+ File.separator + "images\\member";
