package com.spring.god.jiyoung.aop;
...
/* === 주업무(<예:글쓰기, 글수정, 댓글쓰기 등등>를 실행하기 앞서 
    ...
    포인트컷(주업무)과 더불어 어드바이스를 생성하여 동작하도록 만들겠다.       
*/
	...
	public void before(JoinPoint joinPoint) {
		...
		if(session.getAttribute("loginuser") == null) {
			try {
					...
					RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/tiles1/jiyoung/msg.jsp");
