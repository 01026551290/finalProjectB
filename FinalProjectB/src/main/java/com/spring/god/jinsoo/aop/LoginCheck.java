package com.spring.god.jinsoo.aop;
...
public class LoginCheck {
	...
	public void before(JoinPoint joinpoint) {
		...
		// 로그인 유무를 확인하기 위해서 requset 를 통해 session을 얻어온다. 
		...
		if(session.getAttribute("adminvo") == null) {
			try {
					...
					RequestDispatcher dsipatcher = request.getRequestDispatcher("/WEB-INF/views/tiles1/jinsoo/msg.jsp");
