   ...
   <div class="container">
      <div class="row align-items-center">
         ...
         <c:if test="${HotelVO!=null}">
            ...
            <div class="col-md-12 col-lg-5 order-lg-1 aos-init aos-animate"
               data-aos="fade-up">
...
<section class="py-5 bg-light" >
   ...
   <c:if test="${RoomVO!=null}">
      ...
      <c:forEach var="RoomVO" items="${RoomVO}">
         <div class="site-block-half d-block d-lg-flex bg-white" style="padding: 45px 0px 30px 0px; border-radius: 10px;" >
            <div
               class="col-md-12 col-lg-6 ml-auto order-lg-1 " >
            <c:if test="${RoomVO.imgList!=null}">
               <c:forEach var="list" items="${RoomVO.imgList}" >
               <img
                  src="/god/resources/images/room/${list}"
                  alt="Image" class="img-fluid"
             ...
             <div class="col-md-12 col-lg-5 order-lg-2 aos-init aos-animate"
               data-aos="fade-up" style="padding: 20px 0px 0px 30px;" >
