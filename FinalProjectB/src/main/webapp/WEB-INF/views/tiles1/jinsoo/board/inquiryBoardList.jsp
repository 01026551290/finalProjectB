           ...
           <div class="row">
              <div class="col-md-12 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" >
               ...
               <!-- <h1 style="margin-bottom: 30px;">공지사항</h1> -->
                  ...
                  <button type="button" onclick="location.href='<%= ctxPath%>/admin_inquiryBoard.go'" class= "btn btn-primary text-white py-3 px-5 font-weight-bold" style="margin-bottom: 10px; position: relative; left: 830px;">글쓰기</button>
