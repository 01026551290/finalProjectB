...
<div style="padding-left: 10%; margin-bottom: -2%; border: solid 1px red;">
	...
	<form name="addFrm" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
					...
					<c:if test="${adminvo != null}">
						...
						<input type="text" id="name" name="name" value="관리자" class="short" readonly />
					</c:if>
				</td>
			</tr>
			<tr>
		...
		<!-- // #125 답변글쓰기인 경우  부모글의 seq값인  fk_seq  값과 부모글의 groupno 괎과 부모글의 depthno 값으르  hidden 타입으로 보내준다.-->
