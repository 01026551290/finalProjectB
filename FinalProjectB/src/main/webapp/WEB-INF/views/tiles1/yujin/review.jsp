...
/* 
	  $("button[name='delFile']").on("click".function(){
	  	  fn_fileDelete($(this));
	  });
...
/*   
      ...
      function fn_fileAdd(){
          var str = "<input type='file' name='imgFile"+(g_count++)+"'/><button type='button' id='addFile' >Add file</button>";
          $("#fileDiv").append(str);
 ...
 */	 
	...
	function reviewSubmit(){
		...
		frm = document.reviewFrm;
		
		frm.action = "/god/reviewEnd.go";
		frm.method = "post";
		frm.submit();
	}
...
.star>.input>label[for="p1"]{ 
    width: 10px;
    z-index: 10;
}
.star>.input>label[for="p2"]{ 
    width: 20px;
    z-index: 9;
}
.star>.input>label[for="p3"]{ 
    width: 30px;
    z-index: 8;
}
.star>.input>label[for="p4"]{ 
    width: 40px;
    z-index: 7;
}
.star>.input>label[for="p5"]{ 
    width: 50px;
    z-index: 6;
}
.star>.input>label[for="p6"]{ 
    width: 60px;
    z-index: 5;
}
.star>.input>label[for="p7"]{ 
    width: 70px;
    z-index: 4;
}
.star>.input>label[for="p8"]{ 
    width: 80px;
    z-index: 3;
}
.star>.input>label[for="p9"]{ 
    width: 90px;
    z-index: 2;
}
.star>.input>label[for="p10"]{ 
    width: 100px;
    z-index: 1;
}
.star>output{
            ...
            <!-- <form name="reviewFrm" class="bg-white p-md-5 p-4 mb-5 border"> -->
              <div class="row">
                <div class="col-md-12 form-group">
	                ...
	                <span class="star">
						  <span class="input">
						    <input type="radio" name="star" id="p1" value="0.5"><label for="p1">0.5</label>
						    <input type="radio" name="star" id="p2" value="1"><label for="p2">1</label>
						    <input type="radio" name="star" id="p3" value="1.5"><label for="p3">1.5</label>
						    <input type="radio" name="star" id="p4" value="2"><label for="p4">2</label>
						    <input type="radio" name="star" id="p5" value="2.5"><label for="p5">2.5</label>
						    <input type="radio" name="star" id="p6" value="3"><label for="p6">3</label>
						    <input type="radio" name="star" id="p7" value="3.5"><label for="p7">3.5</label>
						    <input type="radio" name="star" id="p8" value="4"><label for="p8">4</label>
						    <input type="radio" name="star" id="p9" value="4.5"><label for="p9">4.5</label>
						    <input type="radio" name="star" id="p10" value="5"><label for="p10">5</label>
						  </span>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="title">Title</label>
              ...
              <div class="row mb-4">
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="content">Content</label>
...
<!-- 
                  <button type="button" id="delFile"> delete</button><br>
 ...
 -->                
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <button type="button" onclick="reviewSubmit();" class="btn btn-primary text-white py-3 px-5 font-weight-bold">Submit</button>
                </div>
              </div>
            </form>
